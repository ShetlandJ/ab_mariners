<template>
  <div class="app-container transition-colors duration-200" :class="{ 'dark': isDarkMode }">
    ...
    <nav class="fixed top-0 left-0 h-full w-64 bg-gray-800 text-white p-4 z-10">
      <div class="mb-8">
    ...
    <div class="pl-64 w-full min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
      ...
      <div class="dark-mode-toggle flex items-center justify-end p-4 sticky top-0 z-10 bg-white dark:bg-gray-900">
        <button 
