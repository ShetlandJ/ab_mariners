<template>
  <div class="reports-view">
    ...
    <div v-if="activeReport" class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      ...
      <div class="mb-4 flex items-center text-sm">
        ...
        <span class="text-gray-600 dark:text-gray-300">{{ getReportTitle(activeReport) }}</span>
      </div>
      
      <!-- Render appropriate report based on activeReport value -->
